...
%\end{xslide}
 ...
 Cf \href{http://www.evolutionoftheweb.com}{\monbleu{\texttt{evolutionoftheweb.com}}} \& wikipage \href{https://en.wikipedia.org/wiki/History_of_the_World_Wide_Web}{\monbric{History of the World Wide Web}}
   ...
   \monimp{Web technologies evolved \emph{organically}}, no ``grand design'' \petitun{(economical \& social pressure)}
 \end{mslide}
 ...
 \begin{mslide}
   \frametitle{Web technologies ``outside'' the Web}
   \begin{itemize}
   ...
   \item \monimp{hidden} web (see \href{https://en.wikipedia.org/wiki/Robots_exclusion_standard}{\monvert{\texttt{robots.txt}} ``standard''})
     \item \href{https://en.wikipedia.org/wiki/Web_service}{\monimp{web services}} - using \href{https://en.wikipedia.org/wiki/SOAP}{\monbric{SOAP} \petitun{(Simple Object Access Protocol)}}
   \end{itemize}
 \end{mslide}
\end{document}
