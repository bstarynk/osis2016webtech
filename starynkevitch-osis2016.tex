...
%\end{xslide}
 ...
 \begin{mslide}
   ...
   \begin{itemize}
   \item \monimp{hard} to learn \petitun{(books of 800-1000 pages)}
   \item difficult prototype based object model ; dynamically typed
   \item \monimp{difficult} to implement efficiently
   \item here to stay, won't disappear soon!
   \item \mongra{many critics} available on the web
   \item many \monimp{frameworks} and \monimp{toolkits}
