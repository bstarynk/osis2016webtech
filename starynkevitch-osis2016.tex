...
\end{frame}
 ...
 \begin{mslide}
   ...
   \begin{itemize}
   \item I am a compiler \& static source code analysis guy (\href{http://gcc-melt.org/}{\prodname{\bf \texttt{gcc-melt.org}}}), very far from the Web!
   \item Web technologies are about \monimp{half} of IT economy
   \item static source analysis tools need powerful user interfaces
   \item GUI toolkits (e.g. Qt) are becoming out of fashion
     \item many companies dislike installing software on their own
       developer's laptops, prefering Web interfaces
     \item I feel the need for a persistent tool with a web interface \petitun{(``MELT monitor'')}
     \item \monimp{I am still learning}
       \item I am \mongra{old} enough (born in 1959, grand father) to not have
